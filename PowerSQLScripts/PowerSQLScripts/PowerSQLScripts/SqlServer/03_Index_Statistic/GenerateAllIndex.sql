...
-- Description:	Generate all Index in DB
 -- SQL Server - Generate Index Script 
 -- https://gallery.technet.microsoft.com/scriptcenter/SQL-Server-Generate-Index-fa790441
-- =============================================

 -- SQL Server - Generate Index Script 
 -- https://gallery.technet.microsoft.com/scriptcenter/SQL-Server-Generate-Index-fa790441
--In SQL Server , we can generate Index script in the following ways :
--1.) Under Object Explorer -> Databases -> Database -> Tables - > Indexes -> right-click on index - > Create Script as ..
--2.) Using Generate SQL Server Scripts Wizard - > setting Script Indexes to True
--3.) Using Index.Script method
--4.) I have developed T-SQL script using system views to generate index creation script :
--Example :
